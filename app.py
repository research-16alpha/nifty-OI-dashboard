...
st.title("📈 Options Backtest Dashboard")
...
# ======================================================
# MODE 2 — SELECT BY OPTIMIZATION METRIC
# ======================================================
...
st.subheader(f"📁 Strategy: `{selected_folder}`")
...
st.markdown("### 📑 Trades (First 200 shown)")
